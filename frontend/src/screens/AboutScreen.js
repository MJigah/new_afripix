          ...
          <div className="uk-section-large uk-container about-section-padding">
            ...
            >
              ...
              <div>
                ...
                {data.aboutImage.map((image) => (
                  <div className={image.props} key={image._id}>
                    <div className="uk-cover-container uk-height-medium uk-border-rounded">
                      <img src={image.src} alt data-uk-cover />
                    </div>
                  </div>
                ))}
                </div>
            ...
            >
              <div>
                <div className="uk-text-center">
                  <img src="/img/about-tust.jpg" alt="img-benefits" />
                </div>
              </div>
              <div>
                <div className="section-content">
